(function () {
    ...
    */
    ...
    async function generateChecklist(checklistObj, settings) {
        ...
        let demoText = "<p style='font-size:20px; font-weight: 500;background-color: #6B5875; color: white; text-align: center; padding: 6px;'>This is only a demo, NO CHANGES WILL BE SAVED. To save changes, please create an account.</p>"
        document.getElementById('checklist').insertAdjacentHTML('afterbegin', demoText);
    }
    ...
    // Repurposed to not store checklist.
    async function storeChecklistIntoDB(checklistObj, deleting) {
        document.getElementById("cannot-save-notification").style.display = "block";
    }
